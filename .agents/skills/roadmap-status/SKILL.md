...
name: roadmap-status
description: >
  Read-only projection of one roadmap's live state across every repo — what needs the operator, what is running or recently finished, what stopped and why — joined from artifacts already on disk.
---
