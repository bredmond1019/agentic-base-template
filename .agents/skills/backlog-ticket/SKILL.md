...
**Run entirely inline. Spawn no subagent.** This is a single-file append plus a `state.json`
node write — small enough that a subagent round trip adds latency without adding value.
