...
$ARGUMENTS — optional free-text explanation of what was done today. May be brief ("ported
             the credibility-fixes spec and re-ran validate:content") or detailed (several
             sentences). If provided, it is woven into the DEVLOG prose entry as the primary
