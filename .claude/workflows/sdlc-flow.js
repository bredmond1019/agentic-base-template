...
`, withModel({ label: `review-${reviewAttempts}`, schema: REVIEW_SCHEMA, phase: 'Review' }, reviewModel))
    ...
    if (broad || reviewAttempts >= MAX_REVIEW_ATTEMPTS) {
      ...
      state.bails = [...state.bails, { occurred_at: new Date().toISOString(), task_id: null, check_id: 'review', failing_artifact: null, ownership: null, bail_class: (tr && typeof tr.class !== 'undefined') ? tr.class : null, reason: bailReason, resolution: null }]
