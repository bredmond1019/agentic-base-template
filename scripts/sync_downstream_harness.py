...
CLAUDE_SKILL_SLUGS: list[str] = [
    ...
    # epic (BT.3.E) deliberately has NO matching AGENT_SKILL_SLUGS entry below - per the
    # cli-surface-to-skills roadmap's canonical-skill-root decision, the .agents/skills/ mirror
    # for this initiative's four skills is GENERATED by BT.3.G, never hand-authored. This entry
    # only controls the .claude/skills/ -> every repo's own .claude/skills/ sync, which is the
    # same mechanism every other skill above already uses.
    "epic",
]
