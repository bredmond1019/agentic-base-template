...
ANCHORS = [
    ...
    (".claude/workflows/sdlc-task.js", "isolation-and-branch-naming", 838, 944,
     "docs/workflows/sdlc-task.md", "## In-place vs. `--worktree`"),
    (".claude/workflows/sdlc-task.js", "triage-bail-taxonomy", 1142, 1422,
     "docs/workflows/sdlc-task.md", "## Pipeline"),
    (".claude/workflows/sdlc-task.js", "bookkeep-vault-commit", 1660, 1785,
     "docs/workflows/sdlc-task.md", "## Vaulted `planning/` writes in the per-task loop"),
    (".claude/workflows/sdlc-flow.js", "flags-and-defaults", 265, 278,
